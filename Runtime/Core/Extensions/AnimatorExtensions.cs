...
public static class AnimatorExtensions
{
    ...
    public static IPromise TriggerAndWaitForState(this Animator animator, string trigger, string stateName, int layer = 0)
    {
        animator.SetTrigger(trigger);
        return animator.GetOrAddComponent<AnimatorListener>().WaitForState(animator, stateName, layer).Then(() =>
        {
